...
@Component({
  selector: 'app-admin-new-plantao-box',
  templateUrl: './admin-new-plantao-box.component.html',
  styleUrls: ['./admin-new-plantao-box.component.css']
})
export class AdminNewPlantaoBoxComponent implements OnInit {
  ...
  constructor(
    private dialogRef: MatDialogRef<AdminNewPlantaoBoxComponent>,
  ...
  onSubmit(): void {
    this.plantaoService.adminRegisterPlantao(this.plantao).subscribe(
      (response) => {
